...
**Recipe app** is a recipe application
...
- **Active Record:  - Active Record keep track all the models of the application **
...
```sh
  git clone git@github.com:Piercel2022/recipe_app.git
  cd recipe_app
```
...
## 👥 Author1 <a name="authors">Pierre</a>
